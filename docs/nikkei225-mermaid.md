...
xychart-beta
    ...
    x-axis ["4/7", "4/8", "4/9", "4/10", "4/13", "4/14", "4/15"]
    y-axis "Nikkei 225" 52000 --> 59000
    line [53429.56, 56308.42, 55895.32, 56924.11, 56502.77, 57877.39, 58134.24]
    line [53233.94, 53747.68, 54434.09, 55194.22, 55812.04, 56701.60, 57066.77]
```
...
- 2本目の `line` は5日移動平均です。
- Mermaid の `xychart-beta` は欠損値の扱いが弱いため、5日移動平均を計算できる日付だけを表示しています。
